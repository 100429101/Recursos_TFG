function processOPercentil() {
    if (percentilOFilters.length > 0) {
        percentilOFilters.forEach (entry_ => {
        ...
        console.log("percentilOFilters no contiene datos.");
    }
}